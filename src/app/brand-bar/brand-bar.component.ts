...
export class BrandBarComponent {
  ...
  navItems = [
    { label: 'Monitor my business', link: '/Monitor my business' ,active: false},
  ...
  this.navItems = this.navItems.filter(item => visibleItems.includes(item.label as NavigationItem));
  }
